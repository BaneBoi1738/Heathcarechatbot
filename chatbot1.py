...
def predict_disease_gui():
    symptoms_exp = [Symptom1.get(), Symptom2.get(), Symptom3.get(), Symptom4.get(), Symptom5.get()]
    ...
    chat_display.insert(END, prediction_text + "\n\n")
...
greet_button = Button(root, text="Greet", command=greet_user)
greet_button.pack()

symptom_label = Label(root, text="Enter your symptoms:")
symptom_label.pack()

Symptom1 = Entry(root, width=30)
Symptom1.pack()

Symptom2 = Entry(root, width=30)
Symptom2.pack()

Symptom3 = Entry(root, width=30)
Symptom3.pack()

Symptom4 = Entry(root, width=30)
Symptom4.pack()

Symptom5 = Entry(root, width=30)
Symptom5.pack()
